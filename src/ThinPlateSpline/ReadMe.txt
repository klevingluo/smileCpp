========================================================================
    KONSOLENANWENDUNG: ThinPlateSpline-Projektübersicht
========================================================================

Diese ThinPlateSpline-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Die Datei enthält eine Zusammenfassung des Inhalts der Dateien,
aus denen die ThinPlateSpline-Anwendung besteht.


ThinPlateSpline.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    mit dem Namen ThinPlateSpline.pch sowie eine vorkompilierte 
